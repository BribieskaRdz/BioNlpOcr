...
//		mPrevious.setTextColor(Color.argb(255, col[0], col[1], col[2]));
		mNext.setTextColor(getResources().getColor(R.color.Remedy_GrisAnaranjado));
		mPrevious.setTextColor(getResources().getColor(R.color.Remedy_GrisAnaranjado));
	...
	private void addContent(){
		...
		mCurrent.setTextSize(35);
		mPrevious.setTextSize(25);
		mNext.setTextSize(25);
...
//		mPrevious.setTextColor(Color.argb(255, mUnfocusedTextColor[0], mUnfocusedTextColor[1], mUnfocusedTextColor[2]));
	...
	public void onPageScrollStateChanged(int state) {
		Log.i("VIEWPAGERINDICATOR", "onPageScrollStateChanged - stado="+state);
	}

	@Override
	public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
		Log.i("VIEWPAGERINDICATOR", "onPageScrolled - position="+position+" positionOffset="+positionOffset+" positionOffsetPixels="+positionOffsetPixels);
...
//			builder.setMessage("Deseas Actualizar el ultimo comentario?"+this.comentario+" comentarioActualizado = "+comentarioActualizado+" pos"+this.posicion).setPositiveButton("Si", dialogClickListener).setNegativeButton("No", dialogClickListener).setCancelable(true).show();
	...
	void updatePositions(int positionOffsetPixels){
		...
		Log.i("VIEWPAGERINDICATOR", "updatePositions - positionOffsetPixels="+positionOffsetPixels);
	...
	int updatePosition(int givenPosition, int offset){
		...
		Log.i("VIEWPAGERINDICATOR", "updatePosition - givenPosition="+givenPosition+" offset="+offset);
...
//		mCurrent.setTextColor(Color.argb(255, r, g, b));
		mCurrent.setTextColor(getResources().getColor(R.color.Blanco));
	}
	...
	class OnPreviousClickedListener implements android.view.View.OnClickListener{
		...
		public void onClick(View v) {
			Log.i("VIEWPAGERINDICATOR", "OnPreviousClickedListener - ");
	...
	class OnCurrentClickedListener implements android.view.View.OnClickListener{
		@Override
		public void onClick(View v) {
			Log.i("VIEWPAGERINDICATOR", "OnCurrentClickedListener - ");
	...
	class OnNextClickedListener implements android.view.View.OnClickListener{
		@Override
		public void onClick(View v) {
			Log.i("VIEWPAGERINDICATOR", "OnNextClickedListener - ");
